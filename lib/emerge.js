...
// Makes an immutable deep clone, ignoring (dropping) keys with nil values.
// Disregards frozen objects, trusting them to be deeply immutable.
// Disregards mutable entities that don't inherit from Object or Array, allowing
// the user to take responsibility and store anything in the tree.
...
function nestedValue (value, path) {
  return reduceRight.call(path, enclose, value)
}
